...
indicator is a raw threshold: change_volume_sum > 95th percentile of the
pre-action signal per rep. The data CSVs are produced by scripts/regen_ovs_figs.py.
"""
import json
import matplotlib
matplotlib.use("Agg")
...
def fig6_features():
    ...
    the pre-action 95th percentile of the same rep.
