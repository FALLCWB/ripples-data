...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.20465278.svg)](https://doi.org/10.5281/zenodo.21466448)
...
> F. Lemos et al. (2026). *Action Ripples in Memory — Dataset and Reproduction Scripts* (v2.5.4). Zenodo. https://doi.org/10.5281/zenodo.21466448
...
@dataset{lemos2026ripplesdata,
  ...
  url          = {https://doi.org/10.5281/zenodo.21466448}
}
```
